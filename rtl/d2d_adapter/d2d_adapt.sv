module d2d_adapt #(
  ...
  // FDI config legs (host mailbox, docs/cfg_spec.md).
  ...
  d2d_sb d2d_sideband (
    ...
    .io_fdi_pl_cfg(io_fdi_plConfig_bits),
    .io_fdi_pl_cfg_vld(io_fdi_plConfig_valid),
    .io_fdi_pl_cfg_crd(io_fdi_plConfigCredit),
    .io_fdi_lp_cfg(io_fdi_lpConfig_bits),
    .io_fdi_lp_cfg_vld(io_fdi_lpConfig_valid),
