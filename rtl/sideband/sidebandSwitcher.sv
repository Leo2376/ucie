module sidebandSwitcher(
  input          io_inner_node_to_layer_above_ready,
  output         io_inner_node_to_layer_above_valid,
  output [127:0] io_inner_node_to_layer_above_bits,
  ...
  sidebandOneInTwoOutSwitch outer_node_to_layer_above_subswitch (
  ...
  assign outer_node_to_layer_above_subswitch_io_inner_node_to_layer_ready = 1'h1;
